...
export default function SubscriberInfo({ successCallback }: { successCallback: () => void }) {
          ...
          <form onSubmit={showAdditionalFields ? formik.handleSubmit : checkPhoneNumber}>
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex">
                  <Select onValueChange={(value) => formik.setFieldValue('countryCode', value)} value={formik.values.countryCode}>
                    <SelectTrigger className={cn("w-[130px] rounded-r-none", !formik.values.countryCode && "text-muted-foreground")}>
                ...
                {formik.touched.countryCode && formik.errors.countryCode && (
                  <p className="text-sm text-red-500">{formik.errors.countryCode}</p>
                )}
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    {formik.touched.emiratesId && formik.errors.emiratesId && (
                      <p className="text-sm text-red-500">{formik.errors.emiratesId}</p>
                    )}
                  </div>
                </>
              )}
              ...
              <Button type="submit" className="w-full" disabled={isLoading}>
                {isLoading ? 'Checking...' : showAdditionalFields ? 'Submit' : 'Verify Phone Number'}
              </Button>
            </div>
          </form>
        </CardContent>
